        ...
        <Grid container direction="row-reverse">
          ...
          <Grid item xs={12} md={6} lg={6}>
            <Box className="box_txt">
              ...
              <p className="text_descriptif">
                J'allie savoir faire et experience pour a chaque fois penser,{" "}
                <br /> concevoir et realiser des applications intuitive, <br />{" "}
                sous diverse plateforme que soit
                <br />
                web resposive ou alors{" "}
                <span className="yellow-text"> Android et IOS</span>{" "}
              </p>
              <br />
              <Box className="box_btn">
                ...
                <a
                  href="./pdf/CV-NGUEMBU_FOTSO_Yal_Jovane.pdf"
                  className="btn btn2"
                  download
                >
                  Telecharger CV
